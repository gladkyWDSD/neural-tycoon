...
export interface EffectOp {
  ...
  /** these people go on a break: no work at all until they are back */
  breakFor?: string[]
}
...
export interface PendingEvent {
  ...
  person?: Staff
  /** everybody this ask is on behalf of */
  asking?: string[]
}
...
export interface GameState {
  ...
  /** the week the last group asked for time off, so they ask on a rhythm */
  lastRequestWeek: number
  /** who is on a break, and the week they are back */
